 ...
 */
package com.perficient.lumax.core.models;
...
import com.perficient.lumax.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "perficient-lumax-aem/components/helloworld");
